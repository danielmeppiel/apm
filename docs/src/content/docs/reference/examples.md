---
title: "Examples"
description: "Real-world examples and use cases — from simple instruction sharing to enterprise-scale patterns."
---
...
- **[Context Guide](/apm/introduction/key-concepts/)** - Learn to build custom workflows
- **[Integrations Guide](/apm/integrations/ide-tools/)** - Connect with your existing tools
- **[Getting Started](/apm/getting-started/installation/)** - Set up your first project
