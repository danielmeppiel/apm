---
title: "Installation"
description: "Install APM and configure your environment for AI agent package management."
---
...
See [Prompts Guide](/apm/guides/skills-and-prompts/#running-prompts) for complete auto-discovery documentation.
...
5. **Explore integrations**: Review [Integrations Guide](/apm/integrations/ide-and-tools/) for tool compatibility
