...
description: "How APM compiles multiple packages into optimized AGENTS.md output."
---
...
**Mathematical Core**: [`context_optimizer.py`](https://github.com/microsoft/apm/tree/main/src/apm_cli/compilation/context_optimizer.py)
