---
title: "Dependencies & Lockfile"
description: "Manage package dependencies, workspaces, virtual packages, and the apm.lock file."
---
...
→ See [Skills Guide](/apm/guides/skills-and-prompts/) for complete documentation.
...
- **[Getting Started](/apm/getting-started/installation/)** - Basic APM usage
- **[Context Guide](/apm/introduction/how-it-works/)** - Understanding the AI-Native Development framework
- **[Creating Packages](/apm/introduction/key-concepts/)** - Build your own APM packages

Ready to create your own APM packages? See the [Context Guide](/apm/introduction/key-concepts/) for detailed instructions on building reusable context collections and agent workflows.