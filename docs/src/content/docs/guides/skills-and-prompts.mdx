...
description: "Creating and using skills and prompts in APM packages."
---
...
See [MCP Integration](/apm/integrations/ide-and-tools/#mcp-model-context-protocol-integration) for MCP server configuration and usage.
...
- Learn about [Runtime Integration](/apm/integrations/runtime-compatibility/) to setup and use different AI runtimes
