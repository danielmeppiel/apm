...
<CardGrid>
  ...
  <Card title="Supply Chain Security" icon="approve-check-circle">
    Prompt files are read by agents the moment they land on disk — there's no execution gap. APM scans packages before deployment, blocking threats before your agents can ingest them.
  </Card>
</CardGrid>
