...
<CardGrid>
  <Card title="One Manifest, Every Primitive" icon="document">
  ...
  <Card title="Every Agent, One Setup" icon="rocket">
    Works with GitHub Copilot, Claude Code, Cursor, and OpenCode. The same manifest, the same setup, across agents.
  </Card>
  <Card title="Supply Chain Security" icon="approve-check-circle">
    Prompt files are ingested the moment they hit disk — there's no execution gap. APM scans for hidden Unicode injection before deployment, blocking compromised packages before agents can read them.
  </Card>
</CardGrid>
