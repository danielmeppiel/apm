...
class Plugin:
    ...
    def from_path(cls, plugin_path: Path) -> "Plugin":
        ...
        Plugin structure: {plugin_path}/plugins/ contains agents/, skills/, etc.
        ...
        if not metadata_file.exists():
            raise FileNotFoundError(f"Plugin metadata not found: {metadata_file}")
        ...
        # Plugins use a plugins/ subdirectory for their primitives
        plugins_dir = plugin_path / "plugins"
        if plugins_dir.exists():
            # New structure with plugins/ subdirectory
