...
- Content security scanning: `apm audit` command with `--file`, `--strip`, and pre-deployment scanning that blocks packages containing critical hidden Unicode characters (#313)
