...
class TestContextValidation:
    ...
    def test_get_referenced_contexts(self, resolver, base_dir, sample_primitives):
        ...
        instruction_file.write_text(dedent("""
            ---
            applyTo: "backend/**/*.py"
        ...
        referenced = resolver.get_referenced_contexts(
            all_files_to_scan=[instruction_file]
        )
...
class TestEdgeCases:
    ...
    def test_missing_context_file(self, resolver, base_dir):
        ...
        result = resolver.resolve_links_for_compilation(
            content=content,
            source_file=source_file,
            compiled_output=base_dir / "AGENTS.md"
        )
