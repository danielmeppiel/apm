...
class TestSafeMCPInstaller(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('apm_cli.core.safe_installer.ClientFactory.create_client') as mock_factory, \
    ...
    def test_check_conflicts_only(self):
        ...
        self.assertEqual(conflicts["existing-server"]["canonical_name"], "canonical-existing-server")
