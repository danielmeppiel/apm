...
class TestRegistryClientIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            response = requests.head("https://api.mcp.github.com")
    ...
    def test_specific_real_servers(self):
        ...
        try:
            ...
            if "packages" in docker_server and docker_server["packages"]:
        ...
        try:
            ...
            # Validate it has package information if available
            if "packages" in npx_server and npx_server["packages"]:
